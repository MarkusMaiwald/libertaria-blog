...
| **Ignore** | Deliberate non-engagement. The other entity is filtered out. | Messages from that entity are silently dropped. They cannot reach your attention regardless of entropy spent. |
